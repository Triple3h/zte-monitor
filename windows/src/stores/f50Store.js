...
// Keep the old internal name local to this store while allowing platform-aware
// components (for example the feedback form) to use the same bridge.
const invokeTauri = invokePlatform;
