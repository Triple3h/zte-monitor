...
public class F50Fetcher: ObservableObject {
    ...
    private func executeFetch(
        ...
        // 以兼容 F50 等旧固件。F50 Pro (MU3356) 只有 cpu_temperature 有值，
        // 其余温度键一律回显空串（实测 MU3356V1.0.0B25），所以必须一并请求。
